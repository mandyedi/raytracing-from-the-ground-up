...
class ConeChecker: public Texture {
    public:
        ...
        virtual ConeChecker *clone() const;
...
inline void ConeChecker::set_num_horizontal_checkers(const int num_horizontal) {
    num_horizontal_checkers = num_horizontal;
}

inline void ConeChecker::set_num_vertical_checkers(const int num_vertical) {
    num_vertical_checkers = num_vertical;
}

inline void ConeChecker::set_horizontal_line_width(const float w) {
    horizontal_line_width = w;
}

inline void ConeChecker::set_vertical_line_width(const float w) {
    vertical_line_width = w;
}

inline void ConeChecker::set_color1(const RGBColor &c) {
    color1.r = c.r; color1.g = c.g; color1.b = c.b;
}

inline void ConeChecker::set_color2(const RGBColor &c) {
