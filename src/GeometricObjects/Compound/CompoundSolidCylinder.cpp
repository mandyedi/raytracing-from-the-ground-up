...
CompoundSolidCylinder::CompoundSolidCylinder() : Compound() {
...
CompoundSolidCylinder::CompoundSolidCylinder(const float bottom, const float top, const float radius) : Compound() {
...
CompoundSolidCylinder::CompoundSolidCylinder(const CompoundSolidCylinder& sc) : Compound(sc), bbox(sc.bbox) {}

CompoundSolidCylinder::CompoundSolidCylinder(CompoundSolidCylinder&& sc) noexcept : Compound(std::move(sc)), bbox(std::move(sc.bbox)) {}

CompoundSolidCylinder::~CompoundSolidCylinder() {}

CompoundSolidCylinder& CompoundSolidCylinder::operator=(const CompoundSolidCylinder& sc) {
    Compound::operator=(sc);
    bbox = sc.bbox;
    return *this;
}

CompoundSolidCylinder& CompoundSolidCylinder::operator=(CompoundSolidCylinder&& sc) noexcept {
...
bool CompoundSolidCylinder::shadow_hit(const Ray& ray, float& tmin) const {
    if (bbox.hit(ray)) {
