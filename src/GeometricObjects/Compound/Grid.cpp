...
// #include "../Utilities/FlatMeshTriangle.h"
// #include "../Utilities/SmoothMeshTriangle.h"
// #include "../Utilities/FlatUVMeshTriangle.h"
// #include "../Utilities/SmoothUVMeshTriangle.h"
//
// #include "../Utilities/Triangle.h"
// #include "../Utilities/SmoothTriangle.h"
//
...
bool
Grid::hit(const Ray& ray, float& t, ShadeRec& sr) const {
    float ox = ray.o.x;
    float oy = ray.o.y;
    float oz = ray.o.z;
    float dx = ray.d.x;
