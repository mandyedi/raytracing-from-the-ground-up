...
Torus::Torus(const Torus& t) : GeometricObject(t), a(t.a), b(t.b), bbox(t.bbox) {}

Torus::Torus(Torus&& t) noexcept : GeometricObject(std::move(t)), a(std::exchange(t.a, 2.0f)), b(std::exchange(t.b, 0.5f)), bbox(std::move(t.bbox)) {}
...
Torus& Torus::operator=(Torus&& t) noexcept {
