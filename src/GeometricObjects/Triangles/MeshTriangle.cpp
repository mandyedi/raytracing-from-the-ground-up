...
MeshTriangle&
MeshTriangle::operator= (const MeshTriangle& mt) {
...
MeshTriangle&
MeshTriangle::operator= (MeshTriangle&& mt) noexcept {
...
MeshTriangle::interpolate_u(const float beta, const float gamma) const {
    return( (1.0f - beta - gamma) * mesh_ptr->u[index0]
...
MeshTriangle::interpolate_v(const float beta, const float gamma) const {
    return( (1.0f - beta - gamma) * mesh_ptr->v[index0]
