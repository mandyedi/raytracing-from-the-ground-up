                ...
                bbox(p0, p1)
{
    ...
    Rectangle* bottom_face    = new Rectangle(    Point3D(p0.x + rb, p0.y, p0.z + rb),
                                                Vector3D(0.0f, 0.0f, (p1.z - rb) - (p0.z + rb)),
                                                Vector3D((p1.x - rb) - (p0.x + rb), 0.0f, 0.0f),
    ...
    Rectangle* back_face     = new Rectangle(    Point3D(p0.x + rb, p0.y + rb, p0.z),
                                                Vector3D((p1.x - rb) - (p0.x + rb), 0.0f, 0.0f),
                                                Vector3D(0.0f, (p1.y - rb) - (p0.y + rb), 0.0f),
                                                Normal(0.0f, 0.0f, -1));
...
BeveledBox::BeveledBox(const Point3D& min_corner, const Point3D& max_corner, const float bevel_radius)
    :     Compound(),
        p0(min_corner),
        p1(max_corner),
        rb(bevel_radius),
...
BeveledBox::BeveledBox (BeveledBox&& bb) noexcept
                :     Compound(std::move(bb)),
                    p0(std::move(bb.p0)),
                    p1(std::move(bb.p1)),
...
bool
BeveledBox::hit(const Ray& ray, float& tmin, ShadeRec& sr) const {
    if (bbox.hit(ray)) {
